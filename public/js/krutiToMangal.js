function KtoM(src)
{
var un_cd= convert_to_unicode(document.getElementById(src));
//alert(un_cd);
if(un_cd!=undefined || un_cd=='')
document.getElementById(src).value = convert_to_unicode(document.getElementById(src));
}

﻿function convert_to_unicode(ControlName)
{
...
var modified_substring = ControlName.value  ;

//****************************************************************************************
//  Break the long text into small bunches of max. max_text_size  characters each.
//****************************************************************************************
    var text_size = ControlName.value.length ;
    ...
    while ( chale_chalo == 1 ) 
    {
     ...
     { 
      ...
      while (ControlName.value.charAt ( sthiti2 ) != ' ') {sthiti2--;}
     } 
     else  { sthiti2 = text_size  ;  chale_chalo = 0 }

     var modified_substring = ControlName.value.substring ( sthiti1, sthiti2 )  ;
...
//  processed_text = processed_text.replace( /mangal/g , "Krutidev010" ) ;   
    ...
    ControlName.value = processed_text.replace(/^\s+|\s+$/g,""); 
  ControlName.focus();
   }
