...
use App\Models\Reports\Court\ModelHighCourt;
...
class Caveat extends BaseController
{
    ...
    function __construct()
    {
        ...
        $this->ModelHighCourt= new ModelHighCourt();
    }
    ...
    public function get_caveat_to_caveat(){
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            $final_result= $this->ModelHighCourt->get_caveat_to_caveat($data);
    ...
    public function get_caveat_lower_court_total_count(){
        ...
        if ($this->request->getMethod() === 'post') {
            ...
            $data['inc_tot_pg'] = 0;
            $total_count= $this->ModelHighCourt->get_caveat_lower_court_total_count($data);

            if ($total_count > 0){
                $data['total_count'] = $total_count;
                $final_result= $this->ModelHighCourt->get_content_caveat_lower_court_details($data);
