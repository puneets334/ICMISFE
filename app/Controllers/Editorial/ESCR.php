...
use App\Models\Entities\ModelCasetype;
...
class ESCR extends BaseController
{
    ...
    function __construct()
    {
        ...
        $this->caseTypeModel = new ModelCasetype();
...
//        echo "<pre>"; print_r($casetypes);die;
        if(!empty($casetypes))
        {
...
//                echo "1";die;
                if (((isset($_POST['caseType']))) || (!empty($_POST['caseType'])) && (((isset($_POST['caseNo']))) || (!empty($_POST['caseNo'])))) {
                    ...
                    $getdiarydetail = get_diary_no_from_casetype($caseTypeId, $caseNo, $caseYear);
...
//                echo "<pre>"; print_r($data['diaryDetails']);die;
            }
...
//                     print_r($datewiseData);   die;
            ...
            } elseif ($radio_id == 2)               //        USER WISE FUNCTIONALITY ************************************
            {
                ...
                {
                    $loggedInUserRole=$loggedInUserRole[0]['role'];
                }
                $userwiseData = $this->escr_model->userwise_report($from_date,$to_date,$loggedInUserRole,$userCode);
...
//         echo "<pre>"; print_r($data);  die;
        ...
        echo view('Editorial/show_user_details', $data);
        exit();
    }
