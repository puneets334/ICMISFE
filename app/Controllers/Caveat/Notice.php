        ...
        if(!empty($caveat_diary_matching)){
            foreach($caveat_diary_matching as $row1){
                ...
                if(!empty($is_main_table)){
                    ...
                    $tentative_section = json_decode($this->CaseStatusModel->get_tentative_section($row1['diary_no'],''),true);
                    if (empty($tentative_section)) {
                        $tentative_section = json_decode($this->CaseStatusModel->get_tentative_section($row1['diary_no'],'_a'),true);
                    }
