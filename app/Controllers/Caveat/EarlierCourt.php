...
use App\Models\Entities\CaveatLowerct;
use App\Models\Entities\CaveatLowerctA;

class EarlierCourt extends BaseController
{
    ...
    function __construct()
    {
        ...
        $this->Model_caveat_lowerct = new CaveatLowerct();
        $this->Model_caveat_lowerct_a = new CaveatLowerctA();
    ...
    public function index()
    {
        ...
        if (!empty($data_from_main_caveat)) {
            ...
            $data['case_all_types'] = $this->DropdownListModel->get_lc_hc_casetype($data['l_state'],$data['ct_code']);
            $data['m_ljuddesc'] = $this->DropdownListModel->get_post_t();
            //echo '<pre>';print_r($data['m_ljuddesc']);exit();

            $data['police_station_list'] = $this->DropdownListModel->get_police_station_list($data['l_state'], $data['l_dist']);

            $data['lcc_id'] = null;
            $data['judges_list'] = $this->DropdownListModel->get_all_judges($data['l_state'], $data['ct_code']);
            ...
            $data['states'] = $this->DropdownListModel->icmis_states($data['l_state']);
        ...
        //return view('Caveat/EarlierCourt_view', $data);
        //echo '<pre>';print_r($data['caveat_main']);exit();
        return view('Caveat/EarlierCourt_add_view', $data);
    }
    public function save()
    {
        ...
        $data['states'] = $this->DropdownListModel->icmis_states();
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            $usercode = session()->get('login')['usercode'];
                ...
                if($errorResponse == 1){
                    ...
                    $this->response->redirect(site_url('/Caveat/EarlierCourt'));
                }else{
    ...
    public function update($id = null)
    {
     ...
     //echo '<pre>';print_r($lower_court_details);exit();
        ...
        $caseTypes = $this->DropdownListModel->get_case_type_court($data['l_state'], $data['ct_code']);
        $data['police_station_list'] = $this->DropdownListModel->get_police_station_list($data['l_state'], $data['l_dist']);
        ...
        $data['states'] = $this->DropdownListModel->icmis_states($id_no);
    ...
    public function insertEarlierCourt()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if($_REQUEST['controller']=='U') {
                ...
                return redirect()->to('/Caveat/EarlierCourt/index/'.$this->request->getPost('lc_idd'));
            } else {
                if (!empty($lc_case_no_to)) {
                    $lc_case_no_end = $lc_case_no_to;
                } else {
