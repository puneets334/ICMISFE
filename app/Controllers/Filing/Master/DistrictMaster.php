...
class DistrictMaster extends BaseController
{
    ...
    public function index(){
        ...
        if ($this->request->getMethod() === 'post' && $this->validate([
            ...
            $db->transComplete();
                ...
                session()->setFlashdata("message_error", "District already exist");
            }
        }
        $data['details'] =[];
        $data['details_update']=[];
        $data['state_list'] = $this->DropdownListModel->get_address_state_list(); //echo '<pre>';print_r($data);exit();
