   ...
   public $Model_main_a;
    ...
    public function get_doc_details($diary_number,$diary_year,$is_archival_table='')
    {
        $query = $this->db->table("docdetails$is_archival_table a");
            $query->select('a.diary_no, a.doccode, a.doccode1, docnum, docyear, a.remark, other1, filedby, iastat, ent_dt, advocate_id, verified, docdesc, c.name AS advname, u.name AS entryuser, active_fil_no, active_reg_year, short_description');
