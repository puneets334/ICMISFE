...
class ScefmMatters extends BaseController
{
   public $Model_scefm_matters;
    ...
    public function index()
    {
        ...
        return view('Filing/ScefmMatters/IB_report',$data);
    }
    public function get_all_matters_ib()
    {
        $data['app_name']="SC-efm";
        $data['all_matters']=$this->Model_scefm_matters->get_all_matters_ib();
        return view('Filing/ScefmMatters/IB_report_get_all_matters',$data);
    }
