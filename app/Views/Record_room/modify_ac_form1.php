                                        ...
                                        <div class="panel-body" id="frm">
                                            <form class="form-horizontal" role="form" name="form1" autocomplete="off" id="fid">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2"><input class="form-control " name="acn" value="<?php echo !empty($val['cname']) ? $val['cname'] : ''; ?>" type="text" id="acn" placeholder="Name"> </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input class="form-control" name="cdob" type="date" value="<?php echo !empty($val['dob']) ? $val['dob'] : ''; ?>" id="cdob">
                                                    </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-2">
                                                        <input class="form-control" value="<?php echo !empty($val['regdate']) ? $val['regdate'] : ''; ?>" name="crd" type="date" id="crd">
                                                    </div>
                                                </div>
