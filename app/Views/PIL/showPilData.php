...
<br>
                        <div class="row col-md-12 ">
                            ...
                            <div class="col-md-3" id="divDiaryNo">
                                ...
                                <input type="text" class="form-control" placeholder="Inward No"  id="diaryNo" name="diaryNo" style="margin-left: 54%;margin-top: -11%;">
                            ...
                            <div class="input-group-btn" style="text-align:center ">
                                <button type="button" name="search" id="search-btn" class="btn btn-primary" onclick="formSubmit();checkDiarynumberToAddInGroup();" style="margin-left: 278%;">Search </button>
                            </div>
                            <div class="row">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                foreach ($pilData as $result){
                                    ...
                                    <tr role="row" class="<?= $rowserial ?>">
                                        <td><?= $s++; ?></td>
                                        <td><button type="button" class="btn btn-primary" onclick="addEditPilDetail(<?=$result['id']?>, '<?=base_url()?>./PIL/PilController/')"><?=$result['pil_diary_number']?></button></td>
