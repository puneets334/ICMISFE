...
<!--                            <h4><i class="icon fa fa-ban"></i> Alert!</h4>-->
                        ...
                        <div class="row col-md-12 ">
                            ...
                            <button type="button" name="save" id="save" style="text-align:center;" onClick="submitPilGroupMethod()" class="btn btn-success" >Save </button>&nbsp;
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <button type="button" name="cancel" id="cancel-btn" style="text-align:center" onClick="goBackToPilGroup()" class="btn btn-primary" >Cancel </button>
