<?=view('header'); ?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="dv_content1"   >
                                                ...
                                                <table align="center" cellspacing="1" cellpadding="2" border="0" width="100%">
                                                    <tr><th>Incomplete Matters for <span style="color: #d73d5a"><?php //echo $_SESSION['emp_name_login']; ?></span>
                                                            <?php
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    if(!empty($fil_trap_list) && ($fil_trap_type_row['usertype']!=106  &&  $fil_trap_type_row['usertype']!=105) ){ ?>
                                                                        <table id="example1" class="table table-bordered table-striped" >
                                                                            ...
                                                                            <tr style="background-color: lightgrey"><th>SNo.</th><th>Diary No.</th><?php    if($fil_trap_type_row['usertype']!=107) {?><th>Parties</th><?php }?><th>Dispatch By</th><th>Dispatch On</th><th>Remarks</th><?php    if($fil_trap_type_row['usertype']==107) {?><th>Tentative Listing Date[Listed For]</th> <?php }?>
                                                                            ...
                                                                            foreach ($fil_trap_list as $row){
                                                                                ...
                                                                                ?>
                                                                                <tr style="<?php if($row['remarks']=='FDR -> AOR' || $row['remarks']=='AOR -> FDR') { ?> background-color: #cccccc <?php } ?>"><th><?php echo $sno; ?></th>
    ...
    <script>
        function efiling_number(efiling_number) {
            var url="http://10.249.44.165:91/efiling_search/DefaultController/?efiling_number="+efiling_number;
    ...
    <script type="text/javascript">
        ...
        function recieve_file(iss)
        {
            ...
            $.ajax({
                ...
                data:{id:idd[1],value:type,CSRF_TOKEN: CSRF_TOKEN_VALUE}
            })
                .done(function(msg){
                    $("#result1").html('');
                    updateCSRFToken();
        ...
        $(document).ready(function(){
            ...
            $("[id^='comp']").click(function() {
                ...
                if(c==true)
                {
                    ...
                    $.ajax({
                        ...
                        data: {id: idd[1], value: type, nature: nature,CSRF_TOKEN: CSRF_TOKEN_VALUE}
                    })
                        .done(function (msg) {
                            $("#result1").html('');
                            updateCSRFToken();
            ...
            $("[id^='tag']").click(function(){
                ...
                $.ajax({
                    ...
                    data:{id:idd[1],value:type,tag:tag,CSRF_TOKEN: CSRF_TOKEN_VALUE}
                })
                    .done(function(msg){
                        updateCSRFToken();
                        //$("#result").html(msg);
