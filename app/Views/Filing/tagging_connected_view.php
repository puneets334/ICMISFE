...
<div align="center" style="background-color:mintcream; border: 1px solid #5AFFAC;"><br>
                ...
                <tr valign="top"><th>Connected / LINKED </th>
                    <td width="100%" nowrap="">
                        <div width="100%" nowrap="">
                            ...
                            $connto = "<font color='red'>Main Case </font>: DN - " . substr($connto, 0, -4)."/".substr($connto, -4) . "&nbsp;&nbsp;&nbsp;&nbsp;[<font color='#043fff'>" . $row1['conct_matter_diary']['reg_no_display'] . "</font>] ";echo $connto;?>
    ...
    <table class="table"><tbody><tr align="center"><td>&nbsp;&nbsp;<button type="button" class="btn btn-success" name="addconn1" id="addconn1" onclick="save_rec(1,'L')">CONNECT/ LINK CASE</button</td></tr></tbody></table>
        <?php }?>
