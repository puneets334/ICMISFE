            ...
            <div id="docModal_Data">
                   <div class="ng-binding ng-scope">
                       ...
                       if(isset($result) && !empty($result)){ ?>
                           ...
                           <b>Mobile: </b><?=$result[0]['mobile_no'];?><br><p></p>
                               ...
                               <table  id="datatable_report" class="table table-bordered table-striped datatable_report2">
                                   ...
                                   foreach ($resultSCEFM as $row) { ?>
                                       <tr>
                                           ...
                                           <td><a target="_blank" href="http://10.249.44.165:91/efiling_search/DefaultController/?efiling_number=<?=$row['efiling_no'];?>"><?=$row['efiling_no'];?></a></td>
                                       </tr>
                                   <?php }?>
                                   </tbody>
                       ...
                       if(isset($documents) && !empty($documents)){ ?>
                           ...
                           <b>Mobile: </b><?=$documents[0]['mobile_no'];?><br><p></p>
