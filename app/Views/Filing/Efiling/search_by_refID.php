                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <span class="alert alert-error" style="display: block; color: red;">
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                        <span class="form-response"></span>
                                    </span>

                            <span style="color:red" ng-show="myForm.ack_id.$dirty && myForm.ack_id.$invalid">
                                <span ng-show="myForm.ack_id.$error.required">Ref. No. is required.</span>
                            </span>
                            <span style="color:red" ng-show="myForm.ack_year.$dirty && myForm.ack_year.$invalid">
                                 <span ng-show="myForm.ack_year.$error.required">Year is required.</span>
                            </span>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                                ...
                                                <div id="printTable">
                                                    <table class="table table-striped table-hover">
                                                        ...
                                                        <tr ng-repeat="x in doc_list">
                                                            ...
                                                            <td style="cursor:pointer;" ><input type="checkbox" id="mark" name="mark" ng-model="doc.mark[x.ind_id]" ng-value="{{x.ind_id}}" ng-checked="{{x.file_status!=1}}"></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
