                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    <span style="color: red">Please click SMS button after adding all defects.</span>  <input type="button" class="btn btn-primary" name="btn_sms" id="btn_sms" value="SMS & Email"/>
