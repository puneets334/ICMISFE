<?=view('header') ?>
    <style>
        ...
        .col-form-label {
            ...
            padding-top: calc(-2px + 1px)!important;
                            ...
                            <div id="show_fil">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" name="txt_sclsc_no" id="txt_sclsc_no" size="4" onkeypress="return onlynumbers(event)" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" value="<?=!empty($sclsc) ? $sclsc['sclsc_diary_no'] : ''; ?>" placeholder="Enter No.">
                                                                        <select name="ddl_sclsc_yr" id="ddl_sclsc_yr" class="form-control sp_no_yr" id="sp_no_yr" <?php if($fetch_rw["if_sclsc"]==0 || $fetch_rw["if_sclsc"]=='') { ?> style="display: none" <?php } ?>>
                                                                            <option value="">Select</option>
                                                                            <?php
                                                                            $yr_sclsc=date('Y');
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-5 col-form-label">IF Efiling</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                            <span class="input-group-text">
                                                            ...
                                                            <select name="ddl_efil_yr" id="ddl_efil_yr" class="form-control sp_efil_yr" <?php if($fetch_rw["ack_id"]==0 || $fetch_rw["ack_id"]=='') { ?> style="display: none" <?php } ?>>
                                                                <option value="">Select</option>
                                                                <?php
                                                                $yr_sclsc=date('Y');
                                                                for ($index = $yr_sclsc; $index >=1930; $index--) {
                                    ...
                                    <!-- /.diary_generation_tab_panel -->
                                        <hr><h4 class="basic_heading"> Petitioner Information</h4>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select id="psex" name="psex" class="form-control" disabled>
                                                                <option value="">Select</option>
                                    ...
                                    <!-- /.petitioner_tab_panel -->
                                        ...
                                        <hr/><h4 class="basic_heading"> Respondent Information </h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select id="rsex" name="rsex" class="form-control" disabled>
                                                                <option value="">Select</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="Country" class="col-sm-5 col-form-label">Country<span class="text-red">*</span> :</label>
                                                        <div class="col-sm-7">
                                                            <select id="r_conti" name="r_conti" class="form-control" onchange="setCountry_state_dis(this.id,this.value)" disabled>
                                                                <option value="">Select Country</option>
                                                                <?php
                                                                foreach ($country as $row) {?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="Country" class="col-sm-5 col-form-label">State<span class="text-red">*</span> :</label>
                                                        <div class="col-sm-7">
                                                            <select id="selrsti" name="selrsti" class="form-control" onchange="getDistrict('R',this.id,this.value)" disabled>
                                                                <option value="">Select State</option>
                                                                <?php
                                                                $sel ='';
                                                                foreach ($state_list as $row) {
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="Country" class="col-sm-5 col-form-label">District<span class="text-red">*</span> :</label>
                                                        <div class="col-sm-7">
                                                            <select id="selrdisi" name="selrdisi" class="form-control" disabled>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="Country" class="col-sm-5 col-form-label">State<span class="text-red">*</span> :</label>
                                                        <div class="col-sm-7">
                                                            <select id="selrstd" onchange="getDistrict('R',this.id,this.value)" class="form-control" disabled>
                                                                <option value="">Select State</option>
                                                                <?php
                                                                $sel ='';
                                                                foreach ($state_list as $row) {
    ...
    <script>
        ...
        function get_additional_address_modify(p_r,total_count){
            ...
            $.ajax({
                url: '/Filing/DiaryModify/additional_address_modify',
                cache: false,
                async: true,
