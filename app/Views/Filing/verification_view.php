                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if (empty($get_verification_text)) { ?>
                                        ...
                                        <input type="hidden" name="sub_cate" id="sub_cate" value=" <?php foreach ($cat as $cat_details) : ?>
                    <?= $cat_details->id   ?>
                <?php endforeach; ?>"> <br>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '[id^=accordion] a', function(event) {
            ...
            if (typeof $(this).attr('data-parent') !== "undefined") {
                ...
                if (depId != (acccnt + 1)) {
                    if (depId == (acccnt + 2)) url = "../case_status/get_EarlierCourt.php";
                    ...
                    //    if(depId==6) url="get_EarlierCourt.php";
