    ...
    <section class="content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 diary_section">
                                                <div class="form-group row">
                                                    <label class="col-sm-5 col-form-label">From Diary No</label>
                                                    <div class="col-sm-7">
                                            ...
                                            <div class="col-md-3 diary_section">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-5 col-form-label">From Diary Year</label>
                                                    <div class="col-sm-7">
                                                        <?php $year = 1950;
                                                        $current_year = date('Y');
                                                        ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 casetype_section"">
                                                ...
                                                <div class="form-group row ">
                                                    <label for="inputEmail3" class="col-sm-5 col-form-label">To Diary No</label>
                                                    <div class="col-sm-7">
                                            ...
                                            <div class="col-md-3 casetype_section">
                                                <div class="form-group row">
                                                    <label for="inputEmail3" class="col-sm-5 col-form-label">To Diary Year</label>
                                                    <div class="col-sm-7">
                                                        <?php $year = 1950;
                                                        $current_year = date('Y');
                                                        ?>
        ...
        <script>
            function getDiaryDetails(id)
            {
             ...
             diary_no=dno+dyr;
                $.ajax({
                    url: '<?php echo base_url('Filing/EarlierCourt/getCauseTitle'); ?>',
                    cache: false,
                    async: true,
                    data: {
                        diary_no:diary_no,
            ...
            function copy_details()
            {
                ...
                $.ajax({
                    url: '<?php echo base_url('Filing/EarlierCourt/copylowercourt'); ?>',
                    cache: false,
                    async: true,
                    data: {
