...
<section class="content">
    ...
    <script>
        ...
        function get_transfer_case() {
            ...
            $.ajax({
                type: "GET",
                url: "<?php echo base_url('Filing/ScefmMatters/get_all_matters_ib'); ?>",
        ...
        function efiling_number(efiling_number) {
            ...
            link.href = "http://10.249.44.165:91/efiling_search/DefaultController/?efiling_number="+efiling_number
            link.target = "_blank"
            link.click()
        }
        ...
        function update_case(casetype,diary_no){
            ...
            $.ajax({
                    type: 'POST',
                    url: "<?=base_url('Filing/ScefmMatters/transfer_case')?>",
