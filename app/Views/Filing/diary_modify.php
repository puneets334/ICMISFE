                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-pane" id="respondent_tab_panel">
                                        ...
                                        <center>
                                            ...
                                            <input type="button" class="btn btn-success" value="Save" onclick="call_update_main()" id="svbtn" onkeydown="if (event.keyCode == 13) document.getElementById('svbtn').click()" <?php echo $disabled; ?>/> &nbsp;
