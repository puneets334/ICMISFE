<?=view('header'); ?>
                                ...
                                <div class="card">
                                    <div class="card-header p-2" style="background-color: #fff;">
                                        <ul class="nav nav-pills">
                                            ...
                                            <li class="nav-item"><a class="nav-link" href="<?= base_url() ?>/Filing/IaDocuments/caseBlockList_view" >Case Block for Loose Doc. </a></li>
                                            <li class="nav-item"><a class="nav-link active" href="<?= base_url() ?>/Filing/IaDocuments/verify_defective_view" >Verfify / Defects </a></li>
                                        </ul>
                                        <?php
                                            ...
                                            <div class="active tab-pane" id="verify_defect_tab_panel">
                                                ...
                                                <div class="row mt-5">
                                                    <div class="col-md-12">
                                                        ...
                                                        <table id="example3" class="table table-hover showData">
                                                            <thead>
                                                                <tr>
                                                                    <th>S.No.</th>
                                                                    <th>Action</th>
    ...
    <script>
        ...
        function save_loose(){
            ...
            $.ajax({
                type: 'POST',
                url:"<?php echo base_url('Filing/IaDocuments/save_loose'); ?>",
        ...
        function update_loose(){
            ...
            $.ajax({
                type: 'POST',
                url:'<?php echo base_url('Filing/IaDocuments/loose_up_new'); ?>',
        ...
        $('.caseBlckDelete').on("click",function(){
            ...
            if(confirm("ARE YOU SURE TO REMOVE THIS RECORD") == true){
                ...
                $.ajax({
                    type: 'POST',
                    url:"<?php echo base_url('Filing/IaDocuments/delete_case_block'); ?>",
        ...
        $("#btnMain").click(function(){
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo base_url('Filing/IaDocuments/save_case_block'); ?>",
                async: false,
                data:{CSRF_TOKEN: CSRF_TOKEN_VALUE, data: obj }
            })
            .done(function(msg){
