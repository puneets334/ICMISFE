<table style="margin-left: auto; margin-right: auto; border-collapse: collapse; width: 100%;" border="1" cellspacing="3" cellpadding="3">
    ...
    ?>
        ...
        <tr>
            <td>
            <td> <button class="btn btn-primary editButton" data-toggle="modal" data-target="#myModal">Edit</button>
