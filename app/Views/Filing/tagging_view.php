                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            /*$d=get_diary_case_type(3, 328,2017,'A','B');
                                            print_r($d);*/
                                            ...
                                            <div align="center" style="background-color:mintcream; border: 1px solid #5AFFAC;"><br>
                                                <table bgcolor="#FBFFFD" class="table" width="90%" border="0" cellpadding="3" align="center">
                                                    ...
                                                    <?php  if ($isconn != 'NA') {
                                                        ...
                                                        ?>
                                                    <tr valign="top"><th>Connected To </th>
                                                            <td width="100%" nowrap="">
                                                                <div width="100%" nowrap="">
                                                                    <?php $connto = "<font color='red'>Main Case </font>: DN - " . substr($connto, 0, -4)."/".substr($connto, -4) . "&nbsp;&nbsp;&nbsp;&nbsp;[<font color='#043fff'>" . $row1['conct_matter_diary']['reg_no_display'] . "</font>] ";echo $connto;?>
                                                ...
                                                <br>
                                                <br>
                                                <?php if ($isconn != "Y") { if ($list_after == "" and $status != 'D'):?>
                                                <table class="table">
                                                    <tbody>
                                                    <tr align="center">
                                                ...
                                                <?php endif;?>
                                                <br>
                                                <?php if(!empty($row1['connected_matters'])){$sr_no =0;
                                                ...
                                                <table class="table" width="98%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><font color="#043fff" style=" white-space: nowrap;"><?php echo $reg_no_display;?></font>&nbsp;</td>
            ...
            if (qte_array.length == 0) {
                ...
                if (confirm("Are you sure you want to delink \n" + cn)) {
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: { qte: qte_array ,CSRF_TOKEN: CSRF_TOKEN_VALUE},
        ...
        function delink_main(ttl, ttlp, ttld) {
            ...
            if (confirm("Are you sure you want to DELINK main case?")) {
                $.ajax({
                    type: "POST",
                    url: url,
                    data: { dno: dno, dyr: dyr, ttl: ttl, ttlp: ttlp, ttld: ttld,CSRF_TOKEN: CSRF_TOKEN_VALUE },
                    success: function (msg) {
                        updateCSRFToken();
                        if (msg == "") {
                            alert("DONE");
            ...
            if (qte_array.length == 0) {
                ...
                if (confirm("Are you sure you want to Add Connected Records?")) {
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: { qte: qte_array, dno: dno, dyr: dyr, cl: cl,CSRF_TOKEN: CSRF_TOKEN_VALUE },
                        success: function (msg) {
                            if (msg == ""){
        ...
        function get_case_status(){
            ...
            if (dno1 == dno && dyr == dyr1) alert("Add different case no from Main Case");
                ...
                $.ajax({
                    ...
                    data: {dno: dno, dyr: dyr, dno1: dno1, dyr1: dyr1, ct: cstype,cn:csno,cy:csyr,CSRF_TOKEN: CSRF_TOKEN_VALUE},
