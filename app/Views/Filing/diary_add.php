<?=view('header') ?>
    <style>
        ...
        .basic_heading{text-align: left;color: #31B0D5}
        .btn-sm {
            padding: 0px 8px;
            font-size: 14px;
        }
                        ...
                        <div id="dv_content1"   >
                            ...
                            <div id="show_fil">
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="row ">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <select name="section" id="section"  class="form-control">
                                                                <option value="0" title="Select">Select section</option>
                                                                <?php
                                                ...
                                                <div class="col-md-4 sp_doc_signed" id="sp_doc_signed" style="display: none;">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <input type="date" class="form-control" name="txt_doc_signed" id="txt_doc_signed" size="9" maxlength="15">
                                            ...
                                            <div id="lct_casetype" style="display: none;">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <div class="col-sm-5">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <div class="col-sm-5">
                                                            <input type="text" class="form-control" name="no" id="no" size="10" placeholder="Case no." onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <select name="t_h_cyt" id="t_h_cyt" class="form-control">
                                                                <option value='' >Year</option>
                                                                <?php $year = 1950; $current_year_c = date('Y');
                                                                for ($x = $current_year_c; $x >= $year; $x--) { ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <input type="text" name="diary_no" size="5" id="diary_no" class="form-control" placeholder="Diary no."  onkeyup="this.value=this.value.replace(/[^0-9]/g,'');">
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <select name="dyr" id="dyr" class="form-control">
                                                                <option value="">Year</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" size="4" maxlength="4" id="case_doc" onkeypress="return onlynumbers(event)" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="Total no of pages">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--If SCLSC-->
                                            ...
                                            <div class="col-md-4 sp_no_yr" id="sp_no_yr" style="display: none">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <select name="ddl_sclsc_yr" id="ddl_sclsc_yr" class="form-control select2Stop">
                                                            <option value="">Select</option>
                                                            <?php
                                                            $yr_sclsc=date('Y');
...
<hr/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <select id="psex" name="psex" class="form-control select2Stop">
                                                                    <option value="">Select</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <select  id="selpdisi" name="selpdisi"  class="form-control select2Stop custom-select rounded-0" style="width: 100%;">
                                                                    <option value="">Select</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                ...
                                <hr/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <select id="rsex" name="rsex" class="form-control select2Stop">
                                                                    <option value="">Select</option>
                                                                    <option value="N">N.A.</option>
                                                                    <option value="M">Male</option>
                                                                    <option value="F">Female</option>
                                            ...
                                            <div class="col-md-12 mt-5mb-3">
                                                <div style="text-align: center;font-weight: bold;cursor: pointer;display: none;" id="rsp_add_add" class="btn_addmore btn-outline-success">R.Add Additional Address</div>
                                            </div>

                                            <div class="col-md-12 mt-5mb-3">
                                                <div style="text-align: center;font-weight: bold;cursor: pointer;float: right;" id="ad_address_r" class="cl_center cl_add_address btn_addmore btn-outline-success"><i class='fas fa-plus-circle'></i> Additional Address</div>
                                                <br/><input type="hidden" name="hd_add_address_r" id="hd_add_address_r" value="0"/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <select id="padvt" name="padvt" onchange="changeAdvocate(this.id,this.value)" class="form-control select2Stop" >
                                            ...
                                            <div class="col-md-4" id="padvno_">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" id="padvno" size="25" onchange="getAdvocate_for_main(this.id,'P')"  placeholder="AOR code/Name:/Enrol No">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-content">
                                    <div class="activeStop tab-pane" id="diary_generation_tab_panel">
