                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="active tab-pane" id="manage_category">
                                                    ...
                                                    ?>
                                                    <h4 class="basic_heading">Manage Category</h4><br>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                                    ...
                                                                    <select name="main_category" id="main_category" class="form-control select2" required>
                                                                        ...
                                                                        foreach ($main_categories as $row) {
                                                                            if (isset($row['subcode1'])) {
                                                                                ...
                                                                                echo '<option value="' . sanitize(($row['subcode1'])) . '" ' . $selectedmain_for . '>' . sanitize(strtoupper($row['sub_name1'])) . '</option>';
                                                                            }
                                                                        }
                                                                        ?>
                                                                    </select>
                                                        ...
                                                        <center>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    <button type="submit" class="btn btn-block bg-gradient-success form_save_first" id="saveStep1">Save</button>
                                                                </div>
                                                            </div>
                                                        </center>
                                                    <?php endif; ?>
                                                ...
                                                <div class="tab-pane" id="manage_acts">
                                                    ...
                                                    ?>
                                                    <h4 class="basic_heading"> Manage Act and Section </h4><br>
                                                    <div class="row">
                                                    ...
                                                    <div class="row" style="padding-left: 20px;">
                                                        ...
                                                        ?>
                                                                ...
                                                                <div class="row" id="category_update_row_<?= $i; ?>">
                                                                    ...
                                                                    <div class="col-sm-1">
                                                                        <input type="text" class="form-control" id="section_2[]" name="section_2[]" maxlength="3" onkeypress="return slashnot(event);" value="<?php echo substr($section_name[1], 0, -1); ?>">
                                                                    </div>
                                                                    <div class="col-sm-1">
                                                                        <input type="text" class="form-control" id="section_3[]" name="section_3[]" maxlength="3" onkeypress="return slashnot(event);" value="<?php echo substr($section_name[2], 0, -1); ?>">
                                                                    </div>
                                                                    <div class="col-sm-1">
                                                                        <input type="text" class="form-control" id="section_4[]" name="section_4[]" maxlength="3" onkeypress="return slashnot(event);" value="<?php echo substr($section_name[3], 0, -1); ?>">
                                                                    </div>

                                                                    <div class="col-sm-1">
                                                                        <button type="button" class="btn btn-outline-danger float-sm-right" value="1" onclick="deleteRow('<?php echo $i; ?>');"><i class='fas fa-minus-circle'></i></button>
                                                                    </div>
                                                ...
                                                <div class="tab-pane" id="basic_details">
                                                    ...
                                                    <h4 class="basic_heading">Other Details </h4><br>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group row">
                                                    ...
                                                    <?php if ($case_status == 'P') : ?>
                                                        <center>
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    <button type="submit" class="btn btn-block bg-gradient-success form_save_first" id="saveStep3">Save</button>
                                                                </div>
                                                            </div>
                                                        </center>
                                                    <?php endif; ?>
