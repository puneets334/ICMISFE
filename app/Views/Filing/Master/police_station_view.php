                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    echo form_open(base_url('Filing/Master/PoliceStation/'), $attribute);
                                    ?>
                                                    ...
                                                    <div class="col-sm-7">
                                                        <select name="state_id" id="state_id" class="form-control select2" data-placeholder="Select a state" style="width: 100%;" required>
                                                            ...
                                                            <?php foreach ($state_list as $row) {?>
                                                                <option value="<?php echo $row['state_code'] ?>"><?php echo strtoupper($row['name']); ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
            ...
            $('#state_id').change(function () {
                ...
                if (get_state_id !='') {
                    $.ajax({
                        ...
                        url: "<?php echo base_url('Filing/Master/PoliceStation/getAgency'); ?>",
