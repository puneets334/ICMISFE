                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    echo form_open(base_url('Filing/Master/LowerCourtCaseType/'), $attribute);
                                    ?>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <table id="datatable" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                    <?php $i=1; $court_type=''; foreach($data_list as $row) {
                                                        if ($row['corttyp']=='H'){ $court_type='High Court'; }
                                                        else if ($row['corttyp']=='L'){ $court_type='Lower Court'; }
                                                        ?>
                                                        <tr>
                                                            <td><?=$i++;?></td>
