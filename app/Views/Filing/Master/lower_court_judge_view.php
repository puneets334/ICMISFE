...
<section class="content">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    echo form_open(base_url('Filing/Master/LowerCourtJudge/'), $attribute);
                                    ?>
                                  <center>
                                    <div class="row">
                                        <div class="col-sm-2"></div>
    ...
    <script>
        ...
        function get_judges(jcode){
            ...
            $.ajax({
                url: '<?php echo base_url('Filing/Master/LowerCourtJudge/get_judges'); ?>',
                cache: false,
                async: true,
                data: {CSRF_TOKEN: CSRF_TOKEN_VALUE,jcode:jcode},
                type: 'GET',
