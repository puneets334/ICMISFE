                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-2">
                                <div class="custom_action_menu">
                                    <a href="<?=base_url('Filing/EarlierCourt');?>"><button class="btn btn-success btn-sm" type="button"><i class="fa fa-plus-circle" aria-hidden="true"></i></button></a>
                                    <a href="<?=base_url('Filing/Diary/search');?>"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-search" aria-hidden="true"></i></button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    echo form_open(base_url('Filing/EarlierCourt/insertEarlierCourt/'), $attribute);
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="form-group row ">
                                                        ...
                                                        <label for="inputEmail3" class="col-sm-2 col-form-label"> Select Court <span style="color: red">*</span> :</label>
                                                        <div class="col-sm-8">
                                                            <input type="radio" name="radio_selected_court" id="rd_sc" onClick="display_form(this.value)" <?php if ($ct_code == 4) { ?> checked="checked" <?php } ?> class="cl_hc_dc" value="4" <?php echo $disabled_radio?> /> Supreme Court
                                                            <input type="radio" name="radio_selected_court" id="rd_hc" onClick="display_form(this.value)" <?php if ($ct_code == 1) { ?> checked="checked" <?php } ?> class="cl_hc_dc" value="1" <?php echo $disabled_radio?> /> High Court
                                                            <input type="radio" name="radio_selected_court" id="rd_dc" onClick="display_form(this.value)" <?php if ($ct_code == 3) { ?> checked="checked" <?php } ?> class="cl_hc_dc" value="3" <?php echo $disabled_radio?> /> District Court
                                                            <input type="radio" name="radio_selected_court" id="rd_sa" onClick="display_form(this.value)" <?php if ($ct_code == 5) { ?> checked="checked" <?php } ?> class="cl_hc_dc" value="5" <?php echo $disabled_radio?> /> State Agency
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group date" id="impugned_date5" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" data-target="#impugned_date5" id="impugned_date_5" name="impugned_date_5" value="<?php if ($ct_code == '3') {
                                                                                                                                                                                                        echo $lct_dec_dt;
                                                                                                                                                                                                    } ?>" />
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="icheck-success">
                                                   ...
                                                   // echo ">>".$is_order_challenged;
                                                    ...
                                                    <label for="chk_judge_challenged"></label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <select name="ddl_relied_district" id="ddl_relied_district" class="custom-select rounded-0" style="width:100%;">
                                                    <option value="">SELECT</option>
                                                    <?php  $selected_relied_district = ""; if (!empty($relied_district_list)) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="input-group date" id="government_notification_year" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input" data-target="#government_notification_year" id="government_notification_date" name="government_notification_date" value="<?php echo $gov_not_date; ?>" />
                                                ...
                                                <table id="lowercourtdata" class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($result as $lower_court_details) {
                                                            ...
                                                            $editURL = base_url('Filing/EarlierCourt/index/' . $lower_court_details['lower_court_id']);
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="display: inline-flex !important;"><div class="btn btn-success btn-sm" type="button" onclick="editLowerCourtDetails('<?php echo $sn; ?>')"><i class="fas fa-pen" aria-hidden="true"></i></a></div>
                                                                    <div class="btn btn-danger btn-sm" type="button" onclick="deleteLowerCourt('<?php echo $sn; ?>')"><i class="fa fa-trash" aria-hidden="true"></i></div>
                                                                </td>
                                                                ...
                                                                <td><?php echo date("d-m-Y", strtotime($lower_court_details['lct_dec_dt'])) ?></td>
    ...
    $(document).ready(function() {
        ...
        $('#addButton,#updateButton').click(function() {
            ...
            if (court_type == "4" && impugned_date_s.val().length == 0) {
                ...
                var earlier_insert = jQuery("#earlier_insert");
                jQuery.post("<?php echo base_url('Filing/EarlierCourt/insertEarlierCourt/'); ?>", {
        ...
        //             post_data: earlier_insert.serialize(),
        //         },
        //         url: "<?php echo base_url('Filing/EarlierCourt/updaEarliercourt'); ?>",
        //         success: function(data) {
        //          alert(data);
        //             updateCSRFToken();
...
<script>
    function deleteLowerCourt(id) {
        ...
        if (confirm_record == true) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('Filing/EarlierCourt/deleteEarliercourt'); ?>",
                success: function(data) {
    ...
    function editLowerCourtDetails(id) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('Filing/EarlierCourt/checkforUpdateEarliercourt'); ?>",
                success: function(data) {

                    updateCSRFToken();
                    if ((data == 'Y')) {
                        //alert("Ready for updation");
                        url_redirect = '<?php echo base_url('Filing/EarlierCourt/index/')?>/'+lower_court_id;
                       // alert(url_redirect);
