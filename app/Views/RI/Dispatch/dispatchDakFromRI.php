            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="container-fluid">
                            <h3 class="page-header">Dispatch Letters</h3>
                            <?php
                            ...
                            <input type="hidden" id="status" name="status" value="2">
                                ...
                                <div  class="row" id="divSection" style="display: block">
                                    <div class="form-group col-sm-2 ">
                                        ...
                                        <input type="date" id="fromDate" name="fromDate" class="form-control datepick" autocomplete="off" placeholder="From Date" value="">
                                    </div>
                                    <div class="form-group col-sm-2" >
                                        <label for="from">To Date</label>
                                        <input type="date" id="toDate" name="toDate" class="form-control datepick" placeholder="From Date" autocomplete="off" value="">
                                    </div>
                                    <div class="form-group col-sm-2">
        ...
        function checkFunction() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    record: $("#dispatchDakFromRI").serialize(),
                    },
                dataType: 'JSON',
