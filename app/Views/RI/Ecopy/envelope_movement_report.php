                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="date" id="fromDate" name="fromDate" class="form-control from_date" required placeholder="From Date" value="<?=!empty($fromDate)?$fromDate:null;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="date" id="toDate" name="toDate" class="form-control to_date" required placeholder="From Date" value="<?=!empty($toDate)?$toDate:null;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <button type="button"  style="float:right" id="btn_search" name="btn_search" class="btn btn-block btn-primary">Search</button>
                            </div>
                        </div>
                        <?php form_close(); ?>
                        <br><br><br><br>
