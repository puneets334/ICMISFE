                    ...
                    <div class="card">
                        ...
                        <div class="rowww">
                                    ...
                                    <div class="form-group row " >
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="fromDate" data-target-input="nearest">
                                                <input type="date" class="form-control datetimepicker-input" id="fromDate" name="fromDate" data-target="#fromDate" value="<?= !empty($fromDate)?$fromDate:null; ?>" />
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="input-group date" id="toDate" data-target-input="nearest">
                                                <input type="date" class="form-control datetimepicker-input" id="toDate" name="toDate" data-target="#toDate" value="<?= !empty($toDate)?$toDate:null; ?>" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group row">
                                        <label for="status" class="col-sm-4 col-form-label">Serve Stage:</label>
                                        <div class="col-sm-7">
                            ...
                            <div style="display:flex;justify-content:center" >
                                <button type="button" id="btnGetCases" class="btn btn-primary col-sm-2" onclick="checkFunction();">View</button>
                            </div>
                         </div>
    ...
    <script>
        ...
        function checkFunction() {
            ...
            if(searchBy=="s"){
                ...
                console.log(fromDate+">>>>"+toDate);return false;
                if (fromDate == "") {
