<?= view('header') ?>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group row">
                                                        <label class="col-sm-6 col-form-label">Include/Exclude Connected</label>
                                                        <div class="col-sm-6">
    ...
    <script type="text/javascript">
        ...
        $(document).on("click","#btngetr",function(){
            ...
            $.ajax({
                url:"<?php echo base_url('Coram/RetiredRemoveCoram/remove_coram/');?>",
                type: "post",
        ...
        $(document).on("click","#rem_corm",function(){
            ...
            $.ajax({
                url:"<?php echo base_url('Coram/RetiredRemoveCoram/do_remove_coram/');?>",
                type: "post",
