                                            ...
                                            <div class="row">
                                                ...
                                                <!-- <div style="display:contents;"> -->
                                                    <?php
                                                        ...
                                                        echo form_open('Court/NeutralCitation', $attribute);
                                                    ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="date" name="date" class="form-control" value="<?php echo $listed_date[0]['next_dt'];?>" placeholder="Select date">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
...
<script type="text/javascript">
    ...
    {  //function to check no. of options selected by user
