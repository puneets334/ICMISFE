            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <?=view('Court/NeutralCitation/neutral_citation_breadcrumb'); ?>
                        <!-- /.card-header -->
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <div class="active tab-pane">
                                                <h3 class="basic_heading"> Neutral Citation </h3><br>
...
<script type="text/javascript">
    ...
    $('#dele').click(function(){
        ...
        if (confirm('Are you sure to delete ?')) {
            ...
            $.ajax({
                url:"<?php echo base_url('Court/NeutralCitation/delete_NeutralCitation');?>",
                type: "post",
                data: {CSRF_TOKEN:csrf,case_number:case_number,diary_number:diary_number,date_judgment:date_judgment,ucode:ucode,reason:reason},
            })
            .done(function(msg){
                updateCSRFToken();
                console.log("msg:: ", msg)
                if(msg == 1 || msg == '1'){
                    ...
                    setTimeout(() => {
                        ...
                        window.location = "<?=base_url('Court/NeutralCitation/delete')?>";
                    }, 500);
                }else if(msg == 2){
