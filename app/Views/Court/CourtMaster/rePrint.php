                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="active tab-pane">
                                                <h3 class="basic_heading"> Re Print </h3><br>
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="date" name="txt_o_frmdt" id="txt_o_frmdt" value="<?php echo date('d-m-Y'); ?>" size="6" maxlength="10" class="form-control dtp">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="date" name="txt_o_todt" id="txt_o_todt" value="<?php echo date('d-m-Y'); ?>" size="6" maxlength="10" class="form-control dtp">
                                                        </div>
                                                    </div>
                                                </div>
    ...
    function get_records() {
        ...
        if(order_upload=='' || (txt_o_frmdt=='' || txt_o_frmdt.length<10) || (txt_o_todt=='' || txt_o_todt.length<10)){
            ...
            $.ajax({
                ...
                type: "get",
                beforeSend:function(){
                    $("#showData").html("<div style='margin:0 auto;margin-top:20px;width:6%'><img src='<?php echo base_url('images/load.gif'); ?>'></div>");
                },
                data: {CSRF_TOKEN:csrf,order_upload:order_upload,txt_o_frmdt:txt_o_frmdt,txt_o_todt:txt_o_todt},
