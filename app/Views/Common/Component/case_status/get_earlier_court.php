<div width="100%">
    ...
    <table  border="0" align="left" width="100%" id="lowercourtdata" class="table table-bordered table-striped">
        ...
        <?php
        $sn = 0; //print_r($result);
        foreach ($EarlierCourt as $lower_court_details) {
        $cnr_designation = "";
        ...
        <tr>
            ...
            <td><?php echo $lower_court_details['judgement_covered_in'] ?>
            </td><?php echo $lower_court_details['code'] . ' ' . $lower_court_details['vehicle_no'] ?>
            <td>
            </td>
            <td><?php
