                        ...
                        <table id="userwisereport" class="table table-bordered table-striped datatable_report">
                                        ...
                                        foreach ($list_stats as $result) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url() ?>/Editorial/ESCR/user_report_details?empid=<?php echo $result['empid']; ?>&from_date=<?php echo $from_date; ?>&to_date=<?php echo $to_date; ?>&userrole=<?php echo $userrole; ?>" > <?php echo $result['updated']; ?></td>
                                            </tr>
