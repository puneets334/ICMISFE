            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header heading">
                        ...
                        <div class="row">
                            <div class="col-sm-10"> <h3 class="card-title">Master Management >> Menu List</h3></div>
                                ...
                                <div class="form-div">
                                    ...
                                    <div class="d-block text-center">
                                        ...
                                        <div id="loginbox" style="margin-top:20px;" class="mainbox">
                                            ...
                                            <div class="panel panel-info" id="addMenusDiv">
                                                <div class="panel-heading">
                                                    <div class="panel-title">
                                                        Create <span class="text-danger">[ Menus > Childs ]</span>
                                                        <span class="menusList">
				                        		<a href="#" id="menusList"><i class="fa fa-list">&nbsp;</i>Menus list</a>
				                        		<a href="#" id="usersList"><i class="fa fa-users">&nbsp;</i>Users list</a>
				                        	</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="margin-top: 10px" class="panel-body" >
                                                    ...
                                                    <form id="addNewMenus" class="form-horizontal" autocomplete="off">
                                                        ...
                                                        <div class="row no-margin">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">Old Submenu ID</span>
                                            ...
                                            <div class="panel panel-success hide" id="listUsersDiv">
                                                <div class="panel-heading">
                                                    <div class="panel-title">
                                                        List of [ <span class="fa fa-users text-danger"> Users </span> ]
                                                        <span class="addMenus">
			                        		<a href="#" id="addMenus"><i class="fa fa-plus">&nbsp;</i>Add Menus</a>
			                        		<a href="#" id="menusList"><i class="fa fa-list">&nbsp;</i>Menus List</a>
			                        	</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div style="margin-top: 10px; position: relative;" class="panel-body">
                                                    ...
                                                    <div class="table-responsive dataTables_wrapper dt-bootstrap4 datatablereport_user_wrapper_dataTable">
                                                        ...
                                                        <table id="example" class="table table-striped table-bordered text-left datatablereport_user" style="width:100%">
                                                            <thead>
                                                            <tr>
                                                                <th>#</th>
								        				...
								        				<input type="submit" value="Edit" class="uEdItbtn">
								        				</div>
								        				...
								        				<input type="submit" value="Edit" class="uEdItbtn">
									        					...
									        					<td style="max-width: 20%; text-align:center;">'.$crnAction.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript: void(0);" class="fa fa-edit text-info" id="upermisn" data-id="'.$data['usercode'].'"></a></td>
									        			  </tr>';
                                                                $count++;
                                                            }
                                                            ?>
			                        		...
			                        		<a href="#" id="usersList"><i class="fa fa-users">&nbsp;</i>Users List</a>
                                                ...
                                                <div style="margin-top: 10px" class="panel-body">
                                                    ...
                                                    <div class="table-responsive dataTables_wrapper dt-bootstrap4 query_builder_wrapper_dataTable ">
                                                        <table id="mlist" class="table table-striped table-bordered datatablereport" style="width:100%">
                                                            <thead>
                                                            <tr>
                                                                <th>#</th>
