                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('Filing/Master/DistrictMaster'); ?>" class="nav-link  <?=($uri->getSegment(2)=='Master')?'active':'';?>">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('Filing/SensitiveInfo'); ?>" class="nav-link <?=($uri->getSegment(2)=='SensitiveInfo')?'active':'';?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Sensitive Case</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('Filing/StatisticalReport/data_generation'); ?>" target="_blank" class="nav-link <?=($uri->getSegment(3)=='data_generation')?'active':'';?>">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Statistical Report</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('Filing/StatisticalReport/send_mail'); ?>" target="_blank" class="nav-link <?=($uri->getSegment(3)=='send_mail')?'active':'';?>">
                                    <i class="far fa-circle nav-icon"></i>
