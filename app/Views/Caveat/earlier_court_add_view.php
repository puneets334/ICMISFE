        ...
        <div class="container-fluid">
            <div class="card-header heading">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <a href="<?=base_url('Caveat/EarlierCourt');?>"><button class="btn btn-success btn-sm" type="button"><i class="fa fa-plus-circle" aria-hidden="true"></i></button></a>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div style="text-align: center"><b><span style="color: red"><?php echo $caveat_main['pet_name'] ?> VS <?php echo $caveat_main['res_name'] ?></span></b>
                                                    <br> <b><span style="color: green"><?php echo "Advocate: ". $caveat_main['name'].'['.$caveat_main['aor_code'].']' ?></span></b>
                                                    <br> <b><span style="color: green"><?php echo "Court Fees: Rs. ". $caveat_main['court_fee'].'/-' ?></span></b>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        echo form_open(base_url('Caveat/EarlierCourt/save'), $attribute);
                                        ...
                                        $controller='I';
                                        /* if (isset($is_controller) && $is_controller =='index'){
                                             $controller='U';
                                         }else{
                                             $controller='I';
                                         }*/
                                       ...
                                       <?php if ($caveat_main['c_status'] == 'P') {?>
                                           <input type="hidden" name="hd_d_n_rec_dt" id="hd_d_n_rec_dt" value="<?php echo date('Y-m-d',strtotime($caveat_main['diary_no_rec_date']));  ?>"/>
                                           <input type="hidden" name="hd_casetype_id" id="hd_casetype_id" value="<?php echo $caveat_main['casetype_id']; ?>"/>
                                           <input type="hidden" name="hd_court_nm" id="hd_court_nm" value="<?php echo $caveat_main['from_court']; ?>"/>
                                        <?php }?>
                                        ...
                                        <div id="department_id_1" style="display:none;">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <select name="state_agency_h" id="state_agency_h" class="form-control">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="h_bench_id" id="h_bench_id" class="form-control">
                                                                <option value="">SELECT</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="department_id_5" style="display:none;">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <select name="state_agency_s" id="state_agency_s" class="form-control">
                                                                <option value="">SELECT</option>
                                                                <?php foreach ($states as $state) :
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="district_ids" id="district_ids" class="form-control">
                                                                <option value="">SELECT</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <select name="case_type" id="case_type" class="form-control">
                                                        <option value="">SELECT</option>
                                                        <?php $selected_case_type='';
                                                        if (!empty($case_all_types)) {
                                                ...
                                                <div id="sch_div" class="col-md-4" <?php if ($ct_code == 4) { ?> style="display: block" <?php }else{ ?> style="display: none;" <?php }?>>
                                                    ...
                                                    <select class="form-control" multiple="multiple" data-placeholder="Select a Judge" name="judge_name[]" id="judge_name">
                                        ...
                                        <div id="department_id_3" style="display:none;">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <select name="state_agency_d" id="state_agency_d" class="form-control">
                                                                <option value="">SELECT</option>
                                                                <?php foreach ($states as $state) :
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <select name="case_type_d" id="case_type_d" class="form-control">
                                                        <option value="">Select</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="m_ljuddesc" id="m_ljuddesc" class="form-control" >
                                                        <option value="">Select</option>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="m_policestn" id="m_policestn" class="custom-select rounded-0 form-control">
                                                        <option value="">Select</option>
                                                        <?php $selected_police = "";
                                                    ...
                                                    <div class="form-group">
                                                        <?php if (!empty($action_status) && $action_status=='Y'){
                                                            if (!empty($controller) && $controller=='I') { ?>
                                                                <button type="submit" class="btn btn-block bg-gradient-success form_save_first" id="addButton" onclick="checkvalidations();">Add</button>
                                                            <?php }else { ?>
                                                                <button type="submit" class="btn btn-block bg-gradient-warning form_save_first" id="updateButton">Update</button>
                                                            <?php } }?>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <table id="lowercourtdata" class="table table-bordered table-striped">
                                                            ...
                                                            foreach ($result as $lower_court_details) {
                                                                ...
                                                                $editURL = base_url('Caveat/EarlierCourt/update/' . $lower_court_details['lower_court_id']);
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <?php if (!empty($action_status) && $action_status=='Y'){?>
                                                                        <td>
                                                                            <div class="btn btn-success btn-sm" type="button" onclick="editLowerCourtDetails('<?php echo $sn; ?>')"><i class="fas fa-pen" aria-hidden="true"></i></a></div>
    ...
    <script>
        function deleteLowerCourt(id) {
            ...
            if (confirm_record == true) {
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url('Caveat/EarlierCourt/deleteEarliercourt'); ?>",
                    success: function(data) {
        ...
        function editLowerCourtDetails(id) {
            ...
            $.ajax({
                ...
                url: "<?php echo base_url('Caveat/EarlierCourt/checkforUpdateEarliercourt'); ?>",
                success: function(data) {

                    updateCSRFToken();
                    if ((data == 'Y')) {
                        //alert("Ready for updation");
                        url_redirect = '<?php echo base_url('Caveat/EarlierCourt/update/')?>/'+lower_court_id;
                        // alert(url_redirect);
