...
if (!empty($mainCaveat)){ $caveat_rec_dt=$mainCaveat['diary_no_rec_date']; ?>
            ...
            <div class="similarity">
                <table id="similarity" class="table table-bordered table-striped table-responsive">
                    ...
                    <tr>
                        ...
                        <th> Caveator<br/>Vs<br/>Caveatee</th>
                        <th>From Court</th>
                        <th> State</th>
                        <th>Bench</th>
                        <th>Case No.</th>
                    ...
                    foreach ($caveatSBCJ as $row ){
                       // print_r($caveatSBCJ);
                        ...
                        $diary_no=(!empty($row['c_diary']) && $row['c_diary']!=null) ? substr($row['c_diary'],0,-4).'-'.  substr($row['c_diary'],-4) : '';
                        $r_main=array();
                        if (!empty($row['sub_details'])) {
                            ...
                            if (strtotime($row['diary_no_rec_date']) >= strtotime($caveat_rec_dt)) {
                        ...
                        <tr>
                            ...
                            <td> <?php if($chk_status==1) { ?>
                                ...
                                <?php } ?>
                                <input type="hidden" name="hd_caveat_rec_dt<?php echo $s_no; ?>" id="hd_caveat_rec_dt<?php echo $s_no; ?>" value="<?php echo $row['diary_no_rec_date'];  ?>"/>
                            </td>
                            <td>
                                <span id="sp_diary_no<?php echo $s_no; ?>" class="cl_c_diary"><?=$diary_no;?></span>
                                <input type="hidden" name="hd_caveat_no<?php echo $s_no; ?>" id="hd_caveat_no<?php echo $s_no; ?>" value="<?php echo $row['c_diary']; ?>"/>  <br/>
                            </td>
                            ...
                            <td><?php echo $row['advocate_details'][$row['c_diary']]?></td>
                            <td>
                                    ...
                                    foreach ($row['caveat_diary_matching'] as $row1){
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($row1['caveat_no']==$caveat_number) {?>
                                                        <input type="hidden" name="hd_linked_no<?php echo $s_no; ?>" id="hd_linked_no<?php echo $s_no; ?>" value="<?php echo $row['diary_no']; ?>"/>
                                                        <input type="button" name="hd_unlink<?php echo $s_no; ?>" id="hd_unlink<?php echo $s_no; ?>" value="Unlink" class="cl_unlink"/>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        </table>
            ...
            <div class="similarity2">
                <table id="similarity2" class="table table-bordered table-striped table-responsive">
                    ...
                    <tr>
                        <th style="width: 5%;">S.No. </th>
                        <th style="width: 5%;"> Link </th>
                        <th style="width: 10%;">Caveat No. </th>
                        <th style="width: 10%;"> Caveator<br/>Vs<br/>Caveatee</th>
                        ...
                        <th style="width: 20%;">Linked with Case and Date</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php //$s_no=1;
                    ...
                    foreach ($caveatSBC as $row ){
                        ...
                        if (!empty($row['sub_details'])) {
                            $r_main = $row['sub_details'];
                            $res_case_type_c=$row['short_description'];
                            $short_description_details=$res_case_type_c.'-'.intval(substr($r_main['active_fil_no'],3)).'-'.$r_main['active_fil_dt'];
                            if (strtotime($row['diary_no_rec_date']) >= strtotime($caveat_rec_dt)) {
                                $date1 = date_create($row['diary_no_rec_date']);
                                $date2 = date_create($caveat_rec_dt);
            ...
            <div class="similarity3">
                <table id="similarity3" class="table table-bordered table-striped table-responsive">
                    ...
                    <tr>
                        ...
                        <th style="width: 10%;">Linked with Case and Date</th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php //$s_no=1;
    ...
    <!--similarity-4 -->
    <?php
    if($casetype_id == 5|| $casetype_id==6  ||$casetype_id ==7 || $casetype_id ==8):?>
    ?>
    <div class="row">
        <div class="col-12">
                ...
                <table id="similarity4" class="table table-bordered table-striped table-responsive">
                    ...
                    foreach ($caveatSCC as $row ){
                        ...
                        <tr>
                            ...
                            <td> <?=(!empty($row['c_diary']) && $row['diary_no'] !=null) ? substr($row['c_diary'],0,-4).'-'.  substr($row['c_diary'],-4) : ''; ?>
                                <input type="hidden" name="hd_caveat_no<?php echo $s_no; ?>" id="hd_caveat_no<?php echo $s_no; ?>" value="<?php echo $row['c_diary']; ?>"/> </td>
                        ...
                        <tr>
                            ...
                            <td> <span id="sp_diary_no<?php echo $s_no; ?>" class="cl_c_diary"><?=$diary_no;?></span>
                                <input type="hidden" name="hd_caveat_no<?php echo $s_no; ?>"
                                       id="hd_caveat_no<?php echo $s_no; ?>" value="<?php echo $row['c_diary']; ?>"/>  <br/>
                                <span style="color: black" id="sp_diary_no<?php echo $s_no; ?>"><?=!empty($row['diary_no_rec_date']) ? date('d-m-Y',strtotime($r_main['diary_no_rec_date'])).'<br/>': '';?></span>
                            </td>
                            <td><?=$row['pet_name'].'<br/>Vs<br/>'.$row['res_name']; ?> </td>
                            <td><span id="sp_court_name<?php echo $s_no; ?>"><?php echo $row['court_name']; ?></span> </td>
                            <td><span id="sp_Name<?php echo $s_no; ?>"><?php echo $row['name'];?></span> </td>
            ...
            <div class="similarity6">
                <table id="similarity6" class="table table-bordered table-striped table-responsive">
                    ...
                    <tr>
                        <th style="width: 5%;">S.No. </th>
                        <th style="width: 5%;"> Link </th>
                        <th style="width: 10%;">Caveat No./<br/>Receiving Date</th>
                        <th style="width: 10%;"> Caveator<br/>Vs<br/>Caveatee</th>
                        <th style="width: 10%;">From Court</th>
                        <th style="width: 10%;">State</th>
                        <th style="width: 10%;">Bench</th>
                    ...
                    foreach ($arbitration_ref_date as $row ){
                        ...
                        <tr>
                            ...
                            <td>
                                <span id="sp_diary_no<?php echo $s_no; ?>" class="cl_c_diary"><?=$diary_no;?></span>
                                <input type="hidden" name="hd_caveat_no<?php echo $s_no; ?>" id="hd_caveat_no<?php echo $s_no; ?>" value="<?php echo $row['c_diary']; ?>"/>  <br/>
                                <span style="color: black" id="sp_diary_no<?php echo $s_no; ?>"><?=!empty($row['diary_no_rec_date']) ? date('d-m-Y',strtotime($row['diary_no_rec_date'])).'<br/>': '';?></span>
                            </td>
                            <td><?=$row['pet_name'].'<br/>Vs<br/>'.$row['res_name']; ?> </td>
                            <td><span id="sp_court_name<?php echo $s_no; ?>"><?php echo $row['court_name']; ?></span> </td>
                            <td><span id="sp_Name<?php echo $s_no; ?>"><?php echo $row['name'];?></span> </td>
                ...
                <table id="similarity7" class="table table-bordered table-striped table-responsive">
                    ...
                    foreach ($arbitration_date as $row ){
                        ...
                        <tr>
                            ...
                            <td><span id="sp_diary_no<?php echo $s_no; ?>" class="cl_c_diary"><?php echo substr($row['c_diary'],0,-4).'-'.  substr($row['c_diary'],-4); ?></span>
                                <input type="hidden" name="hd_caveat_no<?php echo $s_no; ?>"
                                       id="hd_caveat_no<?php echo $s_no; ?>" value="<?php echo $row['c_diary']; ?>"/>  <br/>
                                <span style="color: black" id="sp_diary_no<?php echo $s_no; ?>"><?=!empty($row['diary_no_rec_date']) ? date('d-m-Y',strtotime($row['diary_no_rec_date'])).'<br/>': '';?></span>
                            </td>
