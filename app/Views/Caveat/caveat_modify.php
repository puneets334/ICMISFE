                        ...
                        <div class="card-header p-2" style="background-color: #fff;">
                            <ul class="nav nav-pills">
                                ...
                                <?php  $caveat_details= session()->get('caveat_details'); if (!empty($caveat_details)){ ?>
                                    ...
                                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                    <span class="text-success"><b>Caveat Number : </b><?=substr($caveat_details['caveat_no'], 0, -4).'/'.substr($caveat_details['caveat_no'],-4);?></span>
                                <?php }?>
                            </ul>
                        ...
                        <div class="cardbody">
                            <div class="tab-contentStop">
                                ...
                                <div class="tab-pane" id="petitioner_tab_panel">
                                    ...
                                    <div id="for_I_p" style="display: <?php if ($pet_rw['ind_dep']=='I'){ echo 'block';}else{echo 'none';} ?>">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row clearfix">
                                                    ...
                                                    <div class="col-sm-7">
                                                        ...
                                                        <input type="hidden" id="pet_deptt_code" value="<?php echo $pet_rw['addr1'];?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                ...
                                <div class="tab-pane" id="respondent_tab_panel">
                                    ...
                                    <div  id="for_I_r" style="display: <?php if ($res_rw['ind_dep']=='I'){ echo 'block';}else{echo 'none';} ?>">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label  class="col-sm-5 col-form-label">Name<span class="text-red">*</span> :</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label  class="col-sm-5 col-form-label">State<span class="text-red">*</span> :</label>
                                                    <div class="col-sm-7">
                                                        <select id="selrsti" name="selrsti" class="form-control" onchange="getDistrict('R',this.id,this.value)" <?php if($res_rw['country']!='96') echo "disabled";?>>
                                                            <option value="">Select State</option>
                                                            <?php
                                                            $sel ='';
                                                            foreach ($state_list as $row) {
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label  class="col-sm-5 col-form-label">District<span class="text-red">*</span> :</label>
                                                    <div class="col-sm-7">
                                                        <select id="selrdisi" name="selrdisi" class="form-control" <?php if($res_rw['country']!='96') echo "disabled";?>>
                                    ...
                                    <div id="for_D_r" style="display: <?php if ($res_rw['ind_dep'] !='I'){ echo 'block';}else{echo 'none';} ?>">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label  class="col-sm-5 col-form-label">State<span class="text-red">*</span> :</label>
                                                    <div class="col-sm-7">
                                                        <select id="selrstd" onchange="getDistrict('R',this.id,this.value)" class="form-control" <?php if($res_rw['country']!='96') echo "disabled";?>>
                                                            <option value="">Select State</option>
                                                            <?php
                                                            $sel ='';
                                                            foreach ($state_list as $row) {
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label  class="col-sm-5 col-form-label">District<span class="text-red">*</span> :</label>
                                                    <div class="col-sm-7">
                                                        <select id="selrdisd" name="selrdisd" class="form-control" <?php if($res_rw['country']!='96') echo "disabled";?>>
                                                            <option value="">Select District</option>
                                                            <?php
                                                            $sel ='';
                                                            foreach ($res_dist_list as $row) {
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <select id="padvt" name="padvt" onchange="changeAdvocate(this.id,this.value)" class="form-control" >
                                                        <option value="A" <?php if($fetch_rw['padvt']=='A') echo "selected";?>>AOR</option>
                                                        <option value="N" <?php if($fetch_rw['padvt']=='N') echo "selected";?>>Non-AOR</option>
                                                        <option value="S" <?php if($fetch_rw['padvt']=='S') echo "selected";?>>State</option>
                                                        <option value="SS" <?php if($fetch_rw['padvt']=='SS') echo "selected";?>>Petitioner In Person</option>
                                        ...
                                        <div class="col-md-4" id="padvno_">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" id="padvno" value="<?=(!empty($fetch_rw) && (trim($fetch_rw['padvt'])=='A')) ? $petadv_info_rw['aor_code']: $petadv_info_rw['enroll_no'];?>" <?php if($fetch_rw['padvt']=='C' && $fetch_rw['padvt']!='S') echo "disabled"; ?> size="25"  onkeypress="return onlynumbersadv(event)"  onblur="getAdvocate_for_main('P')"  placeholder="Enrol No.(Non-AOR)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4" id="padvyr_">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" id="padvyr" value="<?php echo $petadv_info_rw['enroll_date']?>" <?php if($fetch_rw['padvt']=='C' && $fetch_rw['radvt']!='S') echo "disabled"; ?> size="4" maxlength="4" onblur="getAdvocate_for_main('P')" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');"  disabled="true"/>
