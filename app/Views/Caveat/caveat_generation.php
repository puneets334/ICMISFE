                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4" id="padvno_">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="text" class="form-control" id="padvno" size="25"  onkeypress="return onlynumbersadv(event)"  onblur="getAdvocate_for_main('P')"  placeholder="Enrol No.(Non-AOR)">
                                                </div>
                                            </div>
                                        </div>
