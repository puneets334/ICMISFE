                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        echo form_open(base_url('Caveat/EarlierCourt/insertEarlierCourt/'), $attribute);
                                                    ...
                                                    <div class="card-body">
                                                        <table id="lowercourtdata" class="table table-bordered table-striped">
                                                            ...
                                                            foreach ($result as $lower_court_details) {
                                                                ...
                                                                $editURL = base_url('Caveat/EarlierCourt/index/' . $lower_court_details['lower_court_id']);
        ...
        $(document).ready(function() {
            ...
            $('#addButton,#updateButton').click(function() {
                ...
                if (court_type == "4" && impugned_date_s.val().length == 0) {
                    ...
                    var earlier_insert = jQuery("#earlier_insert");
                    jQuery.post("<?php echo base_url('Caveat/EarlierCourt/insertEarlierCourt/'); ?>", {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data == 'Y')) {
                        ...
                        url_redirect = '<?php echo base_url('Caveat/EarlierCourt/index/')?>/'+lower_court_id;
                        // alert(url_redirect);
