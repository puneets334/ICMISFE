...
<section class="content">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header heading">
                        ...
                        <div class="row">
                            <div class="col-sm-10"> <h3 class="card-title">Caveat >> Caveat Diary Matched</h3></div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <?php
                                    $attribute = array('class' => 'form-horizontal','name' => 'CaveatDiaryMatched_search', 'id' => 'CaveatDiaryMatched_search', 'autocomplete' => 'off');
    ...
    <script>
        $('#CaveatDiaryMatched_search').on('submit', function () {
            ...
            if ($('#CaveatDiaryMatched_search').valid()) {
                ...
                if(validateFlag){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?=base_url('Caveat/CaveatDiaryMatched/get_CaveatDiaryMatched')?>",
                        data: form_data,
                        beforeSend: function () {
