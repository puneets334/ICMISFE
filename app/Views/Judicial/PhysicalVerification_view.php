                                                            ...
                                                            <td>
                                                                ...
                                                                if(empty($row['is_verify']) || $row['is_verify']!='Y') { ?>
                                                                    ...
                                                                    <?php } else { ?>
                                                                        ...
                                                                        <button type="button" class="btn  btn-secondary update-physical_verfiy"
            ...
            //   alert(diary_no)          
                ...
                if(diary_no) {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        async: true,
                        data: {CSRF_TOKEN: CSRF_TOKEN_VALUE, dno: diary_no},
                        type: 'POST',
                         // beforeSend: function () {
                        ...
                        success: function (data) {
                            ...
                            if(data != '') {
                                ...
                                if (row_res6.length == 1) {
                                    ...
                                    let htmlInnr = ''
                                    htmlInnr += '<div class="row col-sm-12">'
                                    htmlInnr += '<div class="col-sm-4" id="mainsubjectCategory" style="margin-left: 15px;;">'
                                    htmlInnr += '<label for="category" id="lbl_McategoryCode" class="">Main Subject Category:<span class="required"></span></label>'
                                    htmlInnr += '<select class="form-control" id="mainCategory" name="mainCategory" required>'
                                    ...
                                    if(row_res5.length > 0) {
                                        row_res5.forEach(function(result) {
                                            htmlInnr += '<option value="'+result['id']+'/'+result['subcode1']+'">'+result['subcode1']+'- '+result['sub_name1']+'</option>'
                                        })
                                    }
                                    htmlInnr += '</select>'
                                    htmlInnr += '</div>'
                                    htmlInnr += '<div class="col-sm-4" id="subjectCategory" >'
                                    htmlInnr += '<label for="category" id="lbl_categoryCode" class="">Sub Subject Category:</label>'
                                    htmlInnr += '<select  class="form-control"  id="categoryCode" name="categoryCode"  placeholder="Subject Category" required>'
                                    htmlInnr += '</select>'
                                    htmlInnr += '</div>'
                                    htmlInnr += '</div>'
                                ...
                                html += '<div style="text-align: center;"> Case No. : '+reg_case+' <br>Diary No. : '+string_replace(row_avl['diary_no'])+' <span style="color:blue; font-weight: bold;">'+c_status+'</span><br>'
                                html += pt_rs
                                html += reg_hear
                                html += misc_hear
                                html += '</div>'
                                ...
                                html += '</span>'
                                html += '<span class="sub_div2">'
                                html += '<select name="case_group" id="case_group" required="">'
                                ...
                                html += '<div class="sub_div1">Subject Category :</div>'
                                html += '<div class="card">'
                                html += '<div class="card-body">'
                                html += cat_det
                                html += '</div>'
                                ...
                                html += '</div>'
                                html += '<div class="main_div">'
                                html += '<div class="sub_div1">Registration :</div>'
                                html += '<div class="card">'
                                html += '<div class="card-body">'
                                html += reg_html
                                html += '</div>'
                                ...
                                let EarlierCourt = resData.get_EarlierCourt 
                                let cntr = 0
                                EarlierCourt.forEach(function(row5) {
                                    html += '<tr>'
                                    cntr = cntr +1
                                    html += '<td>'+ cntr +'</td>'
                                    ...
                                    html += '<td>'
                                        if(row5['ref_case_no']==0 || row5['ref_case_no'] == '') { html +="-" } else { html += row5['ref_case_no'] } 
                                        html += ' / '
                                        if(row5['ref_state']==0 || row5['ref_state'] == '') { html +='-'} else { html += row5['ref_state'] } 
                                        html +=' / '
                                        if(row5['ref_district']==0 || row5['ref_district'] == '') { html +='-'} else { html += row5['ref_district'] } 
                                        html +=' / '
                                        if(row5['ref_case_type']==0 || row5['ref_case_type'] == ''){ html +=''} else { html += row5['ref_case_type'] } 
                                        html +='-'
                                        if(row5['ref_case_no']==0 || row5['ref_case_no'] == '') { html +=""} else { html += row5['ref_case_no'] } 
                                        html +='-'
                                        if(row5['ref_case_year']==0 || row5['ref_case_year'] == '') { html +=''} else { html += row5['ref_case_year'] }
                                    html +='</td>'

                                    html +='<td>'
                                        if(row5['relied_court']==0 || row5['relied_court'] == '') { html +="-"} else { html += row5['relied_court'] } 
                                        html +=' / '
                                        if(row5['relied_state']==0 || row5['relied_state'] == '') { html +='-'} else { html += row5['relied_state']; } 
                                        html +=' / '
                                        if(row5['relied_district']==0 || row5['relied_district'] == '') { html +='-'} else { html += row5['relied_district'] ;} 
                                        html +=' / '
                                        if(row5['relied_case_type']==0 || row5['relied_case_type'] == ''){ html +=''} else { html += row5['relied_case_type']; } 
                                        html +='-'
                                        if(row5['relied_case_no']==0 || row5['relied_case_no'] == '' || row5['relied_case_no'] == null ) { html +=""} else { html += row5['relied_case_no']; } 
                                        html +='-'
                                        if(row5['relied_case_year']==0 || row5['relied_case_year'] == '' || row5['relied_case_year'] == null ) { html +=''} else { html += row5['relied_case_year']; }
                                    html +='</td>'

                                    html +='<td>'
                                        if(row5['transfer_court']==0 || row5['transfer_court']== '') { html +='-' } else { html += row5['transfer_court'] } 
                                        html +=' / '
                                        if(row5['transfer_state']==0 || row5['transfer_state']== '') { html +='-' } else { html += row5['transfer_state'] } 
                                        html +=' / '
                                        if(row5['transfer_district']==0 || row5['transfer_district']== '') { html +='-' } else { html += row5['transfer_district'] } 
                                        html +=' / '
                                        if(row5['transfer_case_type']==0 || row5['transfer_case_type']== ''){ html +='' } else { html += row5['transfer_case_type'] } 
                                        html +='-'
                                        if(row5['transfer_case_no']=='0' || row5['transfer_case_no']== '' || row5['transfer_case_no']==null || row5['transfer_case_no']=='') { html += "" } else { html += row5['transfer_case_no'] } 
                                        html += '-'
                                        if(row5['transfer_case_year']==0 || row5['transfer_case_year']== '' || row5['transfer_case_year'] == null) { html += '' } else { html += row5['transfer_case_year'] }
                                    html +='</td>'

                                    html +='<td>'
                                        if(row5['gov_not_state_id']==0 || row5['gov_not_state_id']== '') { html +="-"} else { html += row5['gov_not_state_id']} 
                                        html +=' / '
                                        if(row5['gov_not_case_type']=='') { ''} else { html += row5['gov_not_case_type'] } 
                                        html +='-'
                                        if(row5['gov_not_case_no']==0 || row5['gov_not_case_no']== '') { '' } else { html += row5['gov_not_case_no'] } 
                                        html +='-'
                                        if(row5['gov_not_case_year']==0 || row5['gov_not_case_year']== ''){ ''} else { html += row5['gov_not_case_year'] } 
                                        html +=' / '
                                        if(row5['gov_not_date']=='0000-00-00' || row5['gov_not_date']=='') { '-'} else { html += row5['gov_not_date'] }
                                    html +='</td>'
                                ...
                                if (act.length > 0) {
                                    ...
                                    html += '<select class="form-control" id="act" name="act" required>'
                                    ...
                                    html += '<label for="category" id="lbl_section" class="">Select Section:</label>'
                                    html += '<select  class="form-control"  id="section" name="section"  placeholder="Select Section" required>'
                                    html += '</select>'
                                    html += '</div>'
                                    html += '</div>'
                                }
                                    ...
                                    setTimeout(() => {
                                        ...
                                        if(act_id){
                                            $.ajax({
                                                ...
                                                type: 'POST',
                                                dataType:'html',
                                                data: { CSRF_TOKEN: CSRF_TOKEN_VALUE, act_id },
                                                // beforeSend: function () {
                                            ...
                                            $("#mainCategory").focus();
                                            $("#mainCategory").css({'border-color':'red'});
                                            return false;
                                        }
                                    }, 400);
                                })
                                    ...
                                    if(mainCategory){
                                        setTimeout(() => {
                                            ...
                                            $.ajax({
                                                ...
                                                type: 'POST',
                                                dataType:'html',
                                                data: { CSRF_TOKEN: CSRF_TOKEN_VALUE, mainCategory},
                                                // beforeSend: function () {
                                    ...
                                    if(callFunction){
                                        ...
                                        setTimeout(() => {
                                            ...
                                            $.ajax({
                                                ...
                                                cache: false,
                                                async: true,
                                                data: { CSRF_TOKEN: CSRF_TOKEN_VALUE, form_data: form_data},
                                                // beforeSend: function () {
                                                //     $('#ajax_result').html('<table widht="100%" align="center"><tr><td><img src="../images/load.gif"/></td></tr></table>');
                                                // },
                                                type: 'POST',
            ...
            if(a==true) {
                ...
                setTimeout(() => {
                    $.ajax({
                        ...
                        cache: false,
                        async: true,
                        data: {CSRF_TOKEN: CSRF_TOKEN_VALUE, valid_dno: valid_dno},
                        beforeSend: function () {
