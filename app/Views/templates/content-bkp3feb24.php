...
switch($old_smenu){
    ...
    case 81232:{
        $url ="Copying/index.php/SensitiveInfo/get_session/".$_SESSION[dcmis_user_idd];
        break;
    }
...
//R&I forwad letter started
    ...
    case 81233:{
        $url="Copying/index.php/SensitiveInfo/SensitiveCasesReport";
        break;
    }
    case 81237:{
...
?>
        <script type="text/javascript">
            window.open('http://10.249.44.165:91/efiling_search', '_blank');
        </script>
<?php
}
  case 999011:{
...
case 90017:{
     $url="Copying/index.php/NeutralCitation/NeutralCitation/".$_SESSION[dcmis_user_idd];
     break;
 }

  case 90018:{
      $url="Copying/index.php/NeutralCitation/get_NeutralCitation/".$_SESSION[dcmis_user_idd];
      break;
  }

case 90019:{
        $url="Copying/index.php/ScefmMatters/get_session/".$_SESSION[dcmis_user_idd];
        break;
    }
