                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <?php
                                        /*if(!empty(session()->get('filing_details'))) {
                                            $filing_details = session()->get('filing_details');
                                            if ($filing_details['c_status'] == 'D') {
//                                                echo "FF";
                                                $current_page_url = base_url('Extension/OfficeReport/dispose_message');
                                            } else if($filing_details['c_status'] == 'P') {*/
//                                                echo "YY";
                                        $current_page_url = base_url('Extension/OfficeReport/report');
                                         //   }
