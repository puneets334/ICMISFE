...
<ul class="nav-breadcrumb">
    <li>
        ...
        ?>
        <a href="<?= $url_district_master; ?>"><button  class="btn btn-block <?php echo $status_color; ?>">Report</button> </a>
    </li>

    <li>
        <?php
        if ($uri->getSegment(3) == 'upload') {
            $ColorCode = 'background-color: #01ADEF';
            $status_color = 'btn-primary';
        ...
        ?>
        <a href="<?= $url_lower_court_case_type; ?>"><button type="button" class="btn btn-block <?php echo $status_color; ?>">Upload</button> </a>
...
/*        if ($uri->getSegment(3) == 'reprint') {
    ...
    <li>
        ...
        ?>
        <a href="<?= $url_lower_court_case_type; ?>"><button type="button" class="btn btn-block <?php echo $status_color; ?>">Copy</button> </a>
