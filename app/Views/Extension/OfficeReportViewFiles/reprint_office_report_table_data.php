...
//                            }
                        ...
                        <td> <?php
                            if($row['display']=='Y') {
                                ?>
                          <input type="button" name="btn_<?php echo $sno; ?>" id="btn_<?php echo $sno; ?>" value="Discard" onclick ="discardFunc(this.id)"/>
                        <?php
                            }
                            else
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.ajax({
                            ...
                            data: {
                                CSRF_TOKEN: CSRF_TOKEN_VALUE,
                                fdate: '<?php if(!empty($fdate)) print_r($fdate); else echo '';?>',
                                tdate: '<?php if(!empty($tdate)) print_r($tdate); else echo '';?>',
                                dno: dno,
