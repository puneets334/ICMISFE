                            ...
                            <div class="col-md-12">
                                <div class="card-header p-2" style="background-color: #fff;">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a onclick="get_search_view(1)" class="nav-link <?php if(($uri->getSegment(4))=="Elimination_list"){ echo 'active';}?>" href="#Elimination_list" id="Elimination List" data-toggle="tab">Elimination List</a></li>
                                        <li class="nav-item"><a onclick="get_search_view(3)" class="nav-link <?php if(($uri->getSegment(4))=='daily_disposal_search'){ echo 'active';}?>" href="#DDR" id="daily_disposal_search_click" data-toggle="tab">Section-Wise</a></li>
                                        <li class="nav-item"><a onclick="get_search_view(4)" class="nav-link <?php if(($uri->getSegment(4))=='gist_module_search'){ echo 'active';}?>" href="#Gist Module" id="gist_module_search_click" data-toggle="tab">Weekly Section List</a></li>
                                        <li class="nav-item"><a onclick="get_search_view(5)" class="nav-link <?php if(($uri->getSegment(4))=='matters_disposed_through_mentioning_search'){ echo 'active';}?>" href="#Matters_Disposed_through_Mentioning" id="matters_disposed_through_mentioning_click" data-toggle="tab">Sec List</a></li>
                                        <li class="nav-item"><a onclick="get_search_view(6)" class="nav-link <?php if(($uri->getSegment(4))=='final_disposal_matters_search'){ echo 'active';}?>" href="#Final_Disposal_Matters" id="final_disposal_matters_search_click" data-toggle="tab">Vacation Registrar List</a></li>
