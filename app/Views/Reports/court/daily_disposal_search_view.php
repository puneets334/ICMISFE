                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="date" max="<?php echo date("Y-m-d"); ?>"  class="form-control" id="on_date" name="on_date" placeholder="Disposal On Date"  value="<?php if(!empty($formdata['on_date'])){ echo $formdata['on_date']; } ?>">
                                </div>
                            </div>
