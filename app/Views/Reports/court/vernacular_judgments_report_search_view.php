                        ...
                        <div class="col-sm-3">
                            <div class="form-group row">
                                <label for="From" class="col-sm-6 col-form-label">
                                    From</label>
                                <div class="col-sm-6">
                                    <input required type="date" class="form-control" id="from_date" name="from_date" placeholder="From Date" value="<?php if(!empty($formdata['from_date'])){ echo $formdata['from_date']; } ?>">
                                </div>
                            </div>
