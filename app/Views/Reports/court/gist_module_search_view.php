                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="date" max="<?php echo date("Y-m-d"); ?>" class="form-control" id="listing_dts" name="listing_dts" placeholder="From Date"  value="<?php if(!empty($formdata['listing_dts'])){ echo $formdata['listing_dts']; } ?>">
                                </div>
                            </div>
...
<script>
    $('#gist_module_search_form').on('submit', function () {
        if ($('#gist_module_search_form').valid()) {
