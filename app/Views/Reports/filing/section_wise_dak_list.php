<div class="card">
    <div class="card-body" >
        <div id="query_builder_wrapper" class="dataTables_wrapper dt-bootstrap4">
            <?php
            //var_dump($section_wise_dak_data['section_wise_dak_data']);
                ...
                <table  id="ReportFileTrap" class="table table-bordered table-striped">
                    ...
                    <?php $sno = 1; foreach($section_wise_dak_data['section_wise_dak_data'] as $row):?>
                        <tr>
                            ...
                            <td>
                                <?php
                                $url= base_url().'/index.php/Reports/Filing/Report/getSectionWiseDakDetails/'.$row->date1;
            ...
            <?php else: { echo "Record Not Found sdfdsf"; } endif; ?>
            <!-- end of fileTrap -->
        </div>
        <script>
            $(function () {
