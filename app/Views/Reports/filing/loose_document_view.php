                        ...
                        <span class="row" id="from_and_to_date_div">
                            <div class="col-sm-3 ">
                                <div class="form-group row ">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" max="<?php echo date("Y-m-d"); ?>" class="form-control" id="from_date" name="from_date" placeholder="From Date" value="<?php if (!empty($formdata['from_date'])) {
                    ...
                    <div class="row ">
                        <div class="col-sm-3">
                            <div class="form-check">
                                <input class="form-check-input" checked type="radio" name="reportType" value="ds" <?php if (!empty($formdata['reportType'])) {
                                                                                                                            if ($formdata['reportType'] == 'ds') {
                                                                                                                                echo 'checked';
                                                                                                                            }
                                                                                                                        } ?>>
                        ...
                        <div class="col-sm-3">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="reportType" value="us" <?php if (!empty($formdata['reportType'])) {
                                                                                                                    if ($formdata['reportType'] == 'us') {
                                                                                                                        echo 'checked';
                                                                                                                    }
                                                                                                                } ?>>
                                <label class="form-check-label">Userwise Report</label>
                            </div>
                        </div>
