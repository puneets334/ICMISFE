    ...
    <div id="search_by_ducument_no" class="row">
        <div class="col-sm-4">
            <div class="form-group ">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control" id="document_no" name="document_no" placeholder="Document No" value="<?php if(!empty($formdata['document_no'])){ echo $formdata['document_no']; } ?>">
                </div>
            </div>
        </div>
        <div class="col-sm-4">
...
/*                    foreach ($usersection as $row) { */?>
    ...
    <div class="row" id="section_wise_report_other_option_div">
        ...
        <div class="icheck-primary d-inline" style="margin-left:15px;" >
            <input type="checkbox" name="exclude_review_contempt_curative_petition" id="exclude_review_contempt_curative_petition" value="ercc" <?php if(!empty($formdata['exclude_review_contempt_curative_petition']) && ($formdata['exclude_review_contempt_curative_petition'] == 'exclude_review_contempt_curative_petition')) {echo 'checked';} ?>>
    ...
    <div class="row ">
        <div class="col-sm-3">
            <div class="form-check">
                ...
                <label class="form-check-label">DAK Section-wise</label>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-check">
                ...
                <label class="form-check-label">DAK Report</label>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-check">
                ...
                <label class="form-check-label">Search by Document Number</label>
            </div>
        </div>
        ...
        <div class="col-sm-3">
            <div class="form-check">
                ...
                <label class="form-check-label">Loose Document Report</label>
            </div>
        </div>
    </div>
...
<script>
        ...
        if ($('#dak_search_form').valid()) {
            ...
            if(validateFlag){ //alert('readt post form');
                ...
                $.ajax({
                    ...
                    /*url: "<?php //echo base_url('Reports/Filing/Report/dak_date_wise'); ?>",*/
                    data: form_data,
                    beforeSend: function () {
    ...
    $(document).ready(function() {
        ...
        $("#dak_user_div").hide();
        $("#sectionDiv").hide();
       /* $("#case_block_and_receive_hide_doc").hide();*/
