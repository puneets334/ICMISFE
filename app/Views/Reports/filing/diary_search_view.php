                ...
                <div class="card-body">
                      <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="date"  max="<?php echo date("Y-m-d"); ?>" class="from_date form-control" id="from_date" name="from_date" placeholder="From Date" value="<?php if(!empty($formdata['from_date'])){ echo $formdata['from_date']; } ?>">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" class="diary_no form-control" id="diary_no" name="diary_no" placeholder="Enter Diary No" value="<?php if(!empty($formdata['diary_no'])){ echo $formdata['diary_no']; }?>">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="icheck-primary d-inline">
                                <input type="checkbox" name="is_inperson" id="is_inperson"
                                    <?php if(!empty($formdata['is_inperson'])){ echo 'checked'; } ?> >
                    ...
                    <div class="row card card-primary card-outline">
                        <div class="col-sm-12 mt-2">
                            <div class="icheck-primary d-inline">
                                <input onclick="uncheck_p_or_e_filed(this.id)" type="checkbox" name="is_efiled_pfiled" id="is_efiled_efiled"  value="efiled" <?php if(!empty($formdata['is_efiled_pfiled'])){ if($formdata['is_efiled_pfield'] == 'efiled') {echo 'checked';} }?> >
                        ...
                        <div class="col-sm-12 mt-2 mb-2">
                          <div class="icheck-primary d-inline">
                           <input onclick="uncheck_p_or_e_filed(this.id)" class="form-check-input" type="checkbox" name="is_efiled_pfiled" id="is_efiled_pfiled" value="pfiled"
                            <?php if(!empty($formdata['is_efiled_pfiled'])){ if($formdata['is_efiled_pfiled'] == 'pfiled') {echo 'checked';} }?> >
                        ...
                        <div class="col-sm-12 mt-2">
                            <div class="icheck-primary d-inline">
                                <input onclick="uncheck_reg_or_def(this.id)" class="form-check-input" id="reg_rmdr" type="checkbox" name="reg_or_def" value="rd"
                                    <?php if(!empty($formdata['reg_or_def'])){ if($formdata['reg_or_def'] == 'rd') {echo 'checked';} }?> >
                        ...
                        <div class="col-sm-12 mt-2 mb-2">
                            <div class="icheck-primary d-inline">
                                <input onclick="uncheck_reg_or_def(this.id)" class="form-check-input" id="reg_dm" type="checkbox" name="reg_or_def" value="rd_dm"
                                    <?php if(!empty($formdata['reg_or_def'])){ if($formdata['reg_or_def'] == 'rd_dm') {echo 'checked';} }?> >
