...
WHERE a.display = 'Y'
AND ((b.diary_no IS NULL) OR (b.next_dt is null AND listorder =0 AND subhead =0 AND mainhead = 'M') OR
...
";
        ...
        if ($response){
            echo 'Data Generation successfully.';
        } else {
            echo 'Data Not Generation successfully.';
        }
        exit();
