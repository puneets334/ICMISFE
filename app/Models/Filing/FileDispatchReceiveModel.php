...
class FileDispatchReceiveModel extends Model
{
    ...
    {
        $builder = $this->db->table('public.fil_trap a')->DISTINCT();
        ...
        $builder->join('public.main b','a.diary_no = b.diary_no','LEFT',false);
        $builder->join('master.users e','e.empid = a.d_by_empid','LEFT',false);
        $builder->join('public.efiled_cases ne',"a.diary_no=ne.diary_no and ne.display='Y' and ne.efiled_type='new_case'",'LEFT',false);
