...
class LoginModel extends Model{
    ...
    public function get_usertype_detials($row_foruser)
    {
        ...
        if ($row_foruser['usercode'] == 1 && $row_foruser['section'] == 71) {$usertype=1;  $type_name='SUPER USER';
            $breadcrumb = [env('FILING_NEW_CASE_DETAIL'), env('FILING_NEW_CASE_EarlierCourt'), env('FILING_NEW_CASE_PARTY'), env('FILING_NEW_CASE_ADVOCATE'), env('FILING_NEW_CASE_CATEGORY'), env('FILING_NEW_CASE_LIMITATION'), env('FILING_NEW_CASE_DEFECT'), env('FILING_NEW_CASE_REFILING'), env('FILING_NEW_CASE_IA_DOCUMNETS'), env('FILING_NEW_CASE_CORAM'), env('FILING_NEW_CASE_TAGGING'), env('FILING_NEW_CASE_REGISTRATION'), env('FILING_NEW_CASE_VERIFICATION'), env('FILING_NEW_CASE_FILE_TRAP'), env('FILING_NEW_CASE_VIEW'),env('FILING_NEW_CASE_SIMILARITY')];
        } else {
            ...
            if ($query->getNumRows() >= 1) {
                ...
                if ($result['usertype'] == 101) {
                    //Filing
                    $breadcrumb = [env('FILING_NEW_CASE_DETAIL'), env('FILING_NEW_CASE_EarlierCourt'), env('FILING_NEW_CASE_ADVOCATE'), env('FILING_NEW_CASE_IA_DOCUMNETS'), env('FILING_NEW_CASE_FILE_TRAP'), env('FILING_NEW_CASE_VIEW'),env('FILING_NEW_CASE_SIMILARITY')];
